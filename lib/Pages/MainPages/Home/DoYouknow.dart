...
class LegalFactsFlashCardSection extends StatefulWidget {
  const LegalFactsFlashCardSection({super.key});

  @override
  _LegalFactsFlashCardSectionState createState() =>
      _LegalFactsFlashCardSectionState();
}

class _LegalFactsFlashCardSectionState
    extends State<LegalFactsFlashCardSection> {
  ...
  void _pickRandomFive() {
    ...
    final shuffled = List<Map<String, String>>.from(initialLegalFacts)
      ..shuffle(random);
    setState(() {
      _activeFacts = shuffled.take(5).toList();
      _currentIndex = 0;
    });
  }
                      ...
                      children: [
                        ...
                        Container(
                          decoration: BoxDecoration(
                            color: MyColors
                                .primary, // theme ke hisaab se adjust karo
